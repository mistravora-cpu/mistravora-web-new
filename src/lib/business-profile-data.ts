...
export const businessDefaults = {
  ...
  seoTitle: "Mistravora | Software Development & Digital Solutions",
  latitude: "",
  longitude: "",
  name: "Mistravora",
  url: "https://www.mistravora.com",
  description: "Mistravora is a Sri Lanka-based software development company serving businesses worldwide with custom software, POS & ERP systems, websites, mobile apps, SEO and digital marketing.",
