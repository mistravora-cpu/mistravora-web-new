...
const fields: FieldDef[] = [
  ...
  { name: "problem_statement", label: "Problem Statement", type: "richtext" },
  { name: "solution", label: "Solution", type: "richtext" },
  { name: "outcome", label: "Outcome", type: "richtext" },
