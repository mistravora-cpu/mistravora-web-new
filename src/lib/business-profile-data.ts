...
export const businessDefaults = {
  ...
  description: "Mistravora is a digital solutions company founded in May 2025 by Husni and co-founded by Shakeel, delivering mobile applications, custom software, websites, SEO, digital marketing and end-to-end digital solutions for businesses of all sizes and industries. With no restriction to a single market or sector, Mistravora focuses on building practical, scalable and modern digital solutions around each client's requirements.",
  intro: "Software development, websites, mobile apps, SEO and digital marketing from Mistravora in Sri Lanka, serving businesses across industries and markets.",
